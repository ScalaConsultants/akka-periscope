...
If you use akka-http, then you can add `akka-periscope-akka-http` to your build. After that you create akka-http `Route`s for both actor tree and actor count using these smart-constructors:
